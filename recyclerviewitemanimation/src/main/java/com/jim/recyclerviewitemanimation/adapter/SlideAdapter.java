package com.jim.recyclerviewitemanimation.adapter;
...
import com.jim.recyclerviewitemanimation.view.SlideRelativeLayout;
...
public class SlideAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        SlideViewHolder slideViewHolder = new SlideViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item, parent, false));
    ...
    public int getItemCount() {
        return null == mItemBeans ? 0 : mItemBeans.size();
    }
